...
public final class MurmurHash3 {
  ...
  /*XXX Does the performance of the hash affect comparison? Do I need to use simple hash functions like
  ...
  //XXX Performance? Simpler hashing for better comparison?
